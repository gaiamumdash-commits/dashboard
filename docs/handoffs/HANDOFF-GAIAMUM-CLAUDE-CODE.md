...
- **9 commits locais prontos, NENHUM publicado ainda** — Fabio ainda não confirmou o push no fim desta sessão. Perguntar antes de continuar (ver "Convenção de push").
